...
po/coredns-859dd66bb5-2nzgd                1/1       Running   0          23h
po/heapster-cfff9f6c4-txjnk                1/1       Running   0          11m
po/kube-router-fhc75                       1/1       Running   0          1d
po/kube-router-gvp2x                       1/1       Running   0          1d
po/kubernetes-dashboard-74f769cbb4-6zshp   1/1       Running   0          5h
po/monitoring-grafana-bc5d7784c-xqgmp      1/1       Running   0          28s
po/monitoring-influxdb-58b6f7974d-jtwng    1/1       Running   0          30m

NAME                       TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)                  AGE
svc/coredns                ClusterIP   10.6.0.2       <none>        53/UDP,53/TCP,9153/TCP   23h
svc/heapster               ClusterIP   10.6.232.250   <none>        80/TCP                   11m
svc/kubernetes-dashboard   NodePort    10.6.145.157   <none>        9090:8100/TCP            5h
svc/monitoring-grafana     NodePort    10.6.85.48     <none>        80:3333/TCP              28s
svc/monitoring-influxdb    ClusterIP   10.6.93.47     <none>        8086/TCP                 30m
```
...
> 上图可见，在dashboard 中已展示出 Pod、Nodes 的 CPU、内存等 metric 图形

\#grafana验证

> 浏览器访问：[http://NodeIP:3333，任意一个NodeIP即可。](http://NodeIP:8100，任意一个NodeIP即可。)

![](/assets/[D92H]0NA%BK_{8LO7NW3YF.png)\#修改配置
